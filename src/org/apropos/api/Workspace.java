...
public class Workspace  extends org.apropos.api.DomainObject  implements java.io.Serializable {
    ...
    private org.apropos.api.Project[] projects;
    ...
    private org.apropos.api.TypeDefinition[] typeDefinitions;

    private org.apropos.api.WorkspaceConfiguration workspaceConfiguration;
    ...
    public Workspace(
           ...
           org.apropos.api.Project[] projects,
           org.apropos.api.RevisionHistory revisionHistory,
           java.lang.String state,
           java.lang.String style,
           org.apropos.api.TypeDefinition[] typeDefinitions,
           org.apropos.api.WorkspaceConfiguration workspaceConfiguration) {
        super(
            ref,
            objectVersion,
            type,
     ...
     * @return projects
     */
    public org.apropos.api.Project[] getProjects() {
        return projects;
    }
     ...
     * @param projects
     */
    public void setProjects(org.apropos.api.Project[] projects) {
        this.projects = projects;
    }
     ...
     */
    public org.apropos.api.TypeDefinition[] getTypeDefinitions() {
        return typeDefinitions;
    }
     ...
     */
    public void setTypeDefinitions(org.apropos.api.TypeDefinition[] typeDefinitions) {
        this.typeDefinitions = typeDefinitions;
    }
     ...
     */
    public org.apropos.api.WorkspaceConfiguration getWorkspaceConfiguration() {
        return workspaceConfiguration;
    }
     ...
     */
    public void setWorkspaceConfiguration(org.apropos.api.WorkspaceConfiguration workspaceConfiguration) {
        this.workspaceConfiguration = workspaceConfiguration;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "Workspace"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "WorkspaceConfiguration"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
