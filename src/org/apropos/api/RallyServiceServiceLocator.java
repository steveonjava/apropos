...
public class RallyServiceServiceLocator extends org.apache.axis.client.Service implements org.apropos.api.RallyServiceService {
    ...
    private java.lang.String RallyService_address = "https://rally1.rallydev.com/slm/webservice/1.15/rallyservice";
    ...
    public org.apropos.api.RallyService_PortType getRallyService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.apropos.api.RallyServiceSoapBindingStub _stub = new org.apropos.api.RallyServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.apropos.api.RallyService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.apropos.api.RallyServiceSoapBindingStub _stub = new org.apropos.api.RallyServiceSoapBindingStub(new java.net.URL(RallyService_address), this);
                _stub.setPortName(getRallyServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/service", "RallyServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/service", "RallyService"));
        }
