...
public class ProjectPermission  extends org.apropos.api.UserPermission  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "ProjectPermission"));
