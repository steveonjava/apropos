...
public class UserProfile  extends org.apropos.api.DomainObject  implements java.io.Serializable {
    private java.lang.String dateFormat;

    private java.lang.String dateTimeFormat;

    private org.apropos.api.Project defaultProject;

    private org.apropos.api.Workspace defaultWorkspace;
    ...
    public UserProfile(
           ...
           org.apropos.api.Project defaultProject,
           org.apropos.api.Workspace defaultWorkspace,
     ...
     */
    public org.apropos.api.Project getDefaultProject() {
        return defaultProject;
    }
     ...
     */
    public void setDefaultProject(org.apropos.api.Project defaultProject) {
        this.defaultProject = defaultProject;
    }
     ...
     */
    public org.apropos.api.Workspace getDefaultWorkspace() {
        return defaultWorkspace;
    }
     ...
     */
    public void setDefaultWorkspace(org.apropos.api.Workspace defaultWorkspace) {
        this.defaultWorkspace = defaultWorkspace;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "UserProfile"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "Workspace"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
