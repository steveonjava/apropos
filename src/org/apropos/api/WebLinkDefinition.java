...
public class WebLinkDefinition  extends org.apropos.api.AttributeDefinition  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "WebLinkDefinition"));
