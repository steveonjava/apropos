...
public class Project  extends org.apropos.api.WorkspaceDomainObject  implements java.io.Serializable {
    private org.apropos.api.BuildDefinition[] buildDefinitions;

    private org.apropos.api.Project[] children;

    private java.lang.String description;

    private org.apropos.api.Iteration[] iterations;
    ...
    private org.apropos.api.Project parent;

    private org.apropos.api.Release[] releases;

    private java.lang.String state;

    private org.apropos.api.User[] users;
    ...
    public Project(
           ...
           org.apropos.api.BuildDefinition[] buildDefinitions,
           org.apropos.api.Project[] children,
           java.lang.String description,
           org.apropos.api.Iteration[] iterations,
           java.lang.String name,
           java.lang.String notes,
           java.lang.String owner,
           org.apropos.api.Project parent,
           org.apropos.api.Release[] releases,
           java.lang.String state,
           org.apropos.api.User[] users) {
        super(
            ref,
            objectVersion,
            type,
     ...
     */
    public org.apropos.api.BuildDefinition[] getBuildDefinitions() {
        return buildDefinitions;
    }
     ...
     */
    public void setBuildDefinitions(org.apropos.api.BuildDefinition[] buildDefinitions) {
        this.buildDefinitions = buildDefinitions;
    }
     ...
     * @return children
     */
    public org.apropos.api.Project[] getChildren() {
        return children;
    }
     ...
     * @param children
     */
    public void setChildren(org.apropos.api.Project[] children) {
        this.children = children;
    }
     ...
     * @return iterations
     */
    public org.apropos.api.Iteration[] getIterations() {
        return iterations;
    }
     ...
     * @param iterations
     */
    public void setIterations(org.apropos.api.Iteration[] iterations) {
        this.iterations = iterations;
    }
     ...
     * @return parent
     */
    public org.apropos.api.Project getParent() {
        return parent;
    }
     ...
     * @param parent
     */
    public void setParent(org.apropos.api.Project parent) {
        this.parent = parent;
    }
     ...
     * @return releases
     */
    public org.apropos.api.Release[] getReleases() {
        return releases;
    }
     ...
     * @param releases
     */
    public void setReleases(org.apropos.api.Release[] releases) {
        this.releases = releases;
    }
     ...
     * @return users
     */
    public org.apropos.api.User[] getUsers() {
        return users;
    }
     ...
     * @param users
     */
    public void setUsers(org.apropos.api.User[] users) {
        this.users = users;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "Project"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "BuildDefinition"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "User"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
