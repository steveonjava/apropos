...
public class User  extends org.apropos.api.DomainObject  implements java.io.Serializable {
    ...
    private org.apropos.api.UserPermission[] userPermissions;

    private org.apropos.api.UserProfile userProfile;
    ...
    public User(
           ...
           org.apropos.api.UserPermission[] userPermissions,
           org.apropos.api.UserProfile userProfile) {
        super(
            ref,
            objectVersion,
            type,
     ...
     */
    public org.apropos.api.UserPermission[] getUserPermissions() {
        return userPermissions;
    }
     ...
     */
    public void setUserPermissions(org.apropos.api.UserPermission[] userPermissions) {
        this.userPermissions = userPermissions;
    }
     ...
     * @return userProfile
     */
    public org.apropos.api.UserProfile getUserProfile() {
        return userProfile;
    }
     ...
     * @param userProfile
     */
    public void setUserProfile(org.apropos.api.UserProfile userProfile) {
        this.userProfile = userProfile;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "User"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "UserPermission"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "UserProfile"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
