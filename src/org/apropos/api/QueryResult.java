...
public class QueryResult  extends org.apropos.api.OperationResult  implements java.io.Serializable {
    ...
    private org.apropos.api.DomainObject[] results;
    ...
    public QueryResult(
           ...
           org.apropos.api.DomainObject[] results) {
        super(
            ref,
            objectVersion,
            type,
     ...
     * @return results
     */
    public org.apropos.api.DomainObject[] getResults() {
        return results;
    }
     ...
     * @param results
     */
    public void setResults(org.apropos.api.DomainObject[] results) {
        this.results = results;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "QueryResult"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "DomainObject"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
