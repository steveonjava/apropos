...
public class WorkspacePermission  extends org.apropos.api.UserPermission  implements java.io.Serializable {
    private org.apropos.api.Workspace workspace;
     ...
     * @return workspace
     */
    public org.apropos.api.Workspace getWorkspace() {
        return workspace;
    }
     ...
     * @param workspace
     */
    public void setWorkspace(org.apropos.api.Workspace workspace) {
        this.workspace = workspace;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "WorkspacePermission"));
