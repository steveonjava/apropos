...
public class UserPermission  extends org.apropos.api.DomainObject  implements java.io.Serializable {
    ...
    private org.apropos.api.User user;
     ...
     * @return user
     */
    public org.apropos.api.User getUser() {
        return user;
    }
     ...
     * @param user
     */
    public void setUser(org.apropos.api.User user) {
        this.user = user;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "UserPermission"));
