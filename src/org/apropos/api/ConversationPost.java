...
public class ConversationPost  extends org.apropos.api.WorkspaceDomainObject  implements java.io.Serializable {
    private org.apropos.api.Artifact artifact;
    ...
    public ConversationPost(
           ...
           org.apropos.api.Artifact artifact,
     ...
     * @return artifact
     */
    public org.apropos.api.Artifact getArtifact() {
        return artifact;
    }
     ...
     * @param artifact
     */
    public void setArtifact(org.apropos.api.Artifact artifact) {
        this.artifact = artifact;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "ConversationPost"));
