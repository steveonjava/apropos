...
public class WorkspaceDomainObject  extends org.apropos.api.DomainObject  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "WorkspaceDomainObject"));
