...
public class Subscription  extends org.apropos.api.PersistableObject  implements java.io.Serializable {
    ...
    private org.apropos.api.Workspace[] workspaces;
    ...
    public Subscription(
           ...
           org.apropos.api.Workspace[] workspaces) {
        super(
            ref,
            objectVersion,
            type,
     ...
     * @return workspaces
     */
    public org.apropos.api.Workspace[] getWorkspaces() {
        return workspaces;
    }
     ...
     * @param workspaces
     */
    public void setWorkspaces(org.apropos.api.Workspace[] workspaces) {
        this.workspaces = workspaces;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "Subscription"));
