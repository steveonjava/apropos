...
public class WorkspaceConfiguration  extends org.apropos.api.WorkspaceDomainObject  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_15/domain", "WorkspaceConfiguration"));
