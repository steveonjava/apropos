...
public class Blocker  extends com.rallydev.webservice.v1_19.domain.DomainObject  implements java.io.Serializable {
    private com.rallydev.webservice.v1_19.domain.User blockedBy;
    ...
    public Blocker(
           ...
           com.rallydev.webservice.v1_19.domain.User blockedBy,
     ...
     * @return blockedBy
     */
    public com.rallydev.webservice.v1_19.domain.User getBlockedBy() {
        return blockedBy;
    }
     ...
     * @param blockedBy
     */
    public void setBlockedBy(com.rallydev.webservice.v1_19.domain.User blockedBy) {
        this.blockedBy = blockedBy;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://rallydev.com/webservice/v1_19/domain", "Blocker"));
